...
/** @type {string} */
const CACHE_VERSION = '1775314926|2688061604';
/** @type {string} */
const CACHE_PREFIX = 'Universal-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'universal-1.3.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["universal-1.3.html","universal-1.3.js","universal-1.3.offline.html","universal-1.3.icon.png","universal-1.3.apple-touch-icon.png","universal-1.3.audio.worklet.js","universal-1.3.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["universal-1.3.wasm","universal-1.3.pck"];
