...
/** @type {string} */
const CACHE_VERSION = '1777043782|3023963429';
/** @type {string} */
const CACHE_PREFIX = 'Universal-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'universal.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["universal.html","universal.js","universal.offline.html","universal.icon.png","universal.apple-touch-icon.png","universal.audio.worklet.js","universal.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["universal.wasm","universal.pck"];
